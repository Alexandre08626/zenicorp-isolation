        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div className="leading-none">
              <div className="font-bold text-sm sm:text-base tracking-tight">ZENI<span className="text-green-500">VA</span></div>
      ...
      <footer className="py-8 px-4 sm:px-6 border-t border-white/10 bg-[#0a0f0a]">
        <div className="max-w-7xl mx-auto text-center">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <span className="font-bold text-xl">ZENIVA ISOLATION</span>
          </div>
