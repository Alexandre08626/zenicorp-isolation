...
export const metadata: Metadata = {
  title: 'Soumission gratuite - Isolation | ZeniCorp',
  ...
  return (
    <div className="container-zenicorp py-12 max-w-2xl">
      <div className="text-center mb-10">
        <p className="text-zenicorp-gold font-semibold uppercase tracking-[0.2em] text-xs mb-3">Division Isolation</p>
      ...
      <form className="card p-8">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            {['Isolation grenier', 'Isolation des murs', 'Performance énergétique'].map((o) => (
        ...
        <div className="mb-8">
          ...
          <textarea className="input-field min-h-32" placeholder="Décrivez votre projet : isolation actuelle, année de construction, courant d'air, humidité..." />
        </div>

        {/* ÉTAPE 6 */}
        <div className="mb-8">
          <h2 className="heading-3 mb-4 flex items-center gap-2">
            <span className="text-zenicorp-gold font-bold">6.</span> Photos des combles et murs
          </h2>
        ...
        <div className="mb-8 bg-zenicorp-lightGray border border-zenicorp-border p-6">
          ...
          <div className="grid grid-cols-2 gap-3 text-sm">
            {[
              ['Type de projet', 'Isolation grenier'],
